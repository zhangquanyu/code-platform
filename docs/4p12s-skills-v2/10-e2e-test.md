...
- **技能定位**: E2E 测试
- **版本**: v2.0.0
- **文件路径**: `docs/4p12s-skills-v2/10-e2e-test.md`
...
- ✅ E2E 测试框架适配 Cypress（推荐）或 Playwright
- ✅ 禁用 Mock 规则适配 Cypress/Playwright API
- ✅ 修复轮次可配置（默认 8 轮）
- ✅ 前端启动命令适配 Vue3 + Vite
...
### 5.3 禁用 Mock 规则（v2 Cypress/Playwright 适配）
