<template>
  <div class="page">
    <el-card>
      ...
      <div class="toolbar"><el-button type="primary" @click="openCreate">新建编排</el-button></div>
...
const query = reactive<OrchPageQuery>({ pageNum: 1, pageSize: 20, keyword: '',
...
async function onDelete(row: OrchestrationVO) { await deleteOrchestration(row.id); ElMessage.success('删除成功'); loadData() }
